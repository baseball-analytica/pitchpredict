...
Usage:
    uv run python -m tools.analysis.accuracy_by_pitch_number \
...
from tools.deep.nn import TOKEN_DTYPE, _CONTEXT_FIELD_SPECS
from tools.deep.dataset import SESSION_START_TOKEN
