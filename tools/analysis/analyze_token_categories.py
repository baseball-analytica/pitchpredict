...
Usage:
    uv run python -m tools.analysis.analyze_token_categories \
...
from tools.deep.nn import _CONTEXT_FIELD_SPECS, TOKEN_DTYPE
from tools.deep.dataset import SESSION_START_TOKEN, SESSION_END_TOKEN
